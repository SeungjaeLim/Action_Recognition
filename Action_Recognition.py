...
Original file is located at
    https://colab.research.google.com/drive/14AIni_ye_ycZI6ghwAJG3cW4y8rEpVJ_

Recognizing an action of a given video using both a convolutional neural network and a recurrent neural network.
"""
